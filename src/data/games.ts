    ...
    games: [
      {
        ...
        description: "Playing on EU servers. Free Trial forever — no regrets. If you spot a Red Mage dramatically casting Verraise on the entire party, that's probably me.",
        descriptionDe: 'Spiele auf EU-Servern. Free Trial für immer — keine Reue. Wer eine Red Mage sieht die dramatisch Verraise auf die gesamte Gruppe castet, das bin wahrscheinlich ich.',
        jobs: [
        ...
        links: [
          { label: '→ Lodestone', href: 'https://eu.finalfantasyxiv.com/lodestone/' },
        ],
      },
    ],
  },
    ...
    games: [
      {
        ...
        description: "There's something deeply satisfying about driving across Europe at 2am with a podcast on. ETS2 is therapy.",
        descriptionDe: 'Es ist irgendwie unglaublich befriedigend um 2 Uhr nachts mit einem Podcast quer durch Europa zu fahren. ETS2 ist Therapie.',
      },
    ],
  },
  {
